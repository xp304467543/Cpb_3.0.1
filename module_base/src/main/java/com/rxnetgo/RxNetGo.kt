...
import com.rxnetgo.cookie.CookieJarImpl
import com.rxnetgo.cookie.store.PersistentCookieStore
import com.rxnetgo.exception.NetErrorEngine
import com.rxnetgo.https.HttpsUtils
import com.rxnetgo.interceptor.LogInterceptor
import com.rxnetgo.model.HttpHeaders
import com.rxnetgo.model.HttpParams
import com.rxnetgo.request.GetRequest
import com.rxnetgo.request.PostRequest
...
import com.rxnetgo.rxcache.diskconverter.GsonDiskConverter
import com.rxnetgo.subscribe.base.BaseSubscriber
import com.rxnetgo.subscribe.base.RxSubscriber
...
class RxNetGo {
    ...
    companion object {
        ...
        const val DEFAULT_MILLISECONDS: Long = 50000     // 默认的超时时间,10秒
