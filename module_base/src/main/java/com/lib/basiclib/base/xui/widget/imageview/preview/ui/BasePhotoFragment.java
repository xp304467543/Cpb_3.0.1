...
import com.lib.basiclib.base.xui.utils.ResUtils;
import com.lib.basiclib.base.xui.widget.imageview.photoview.PhotoViewAttacher;
...
import com.lib.basiclib.base.xui.widget.imageview.preview.loader.ISimpleTarget;
import com.lib.basiclib.base.xui.widget.imageview.preview.loader.OnVideoClickListener;
import com.lib.basiclib.base.xui.widget.imageview.preview.view.SmoothImageView;
import com.lib.basiclib.base.xui.widget.progress.materialprogressbar.MaterialProgressBar;
...
public class BasePhotoFragment extends Fragment {
     ...
     * 预览图片 类型
     */
    public static final String KEY_TRANS_PHOTO = "com.lib.basiclib.base.xui.widget.preview.KEY_TRANS_PHOTO";
    public static final String KEY_SING_FILING = "com.lib.basiclib.base.xui.widget.preview.KEY_SING_FILING";
    public static final String KEY_PREVIEW_ITEM = "com.lib.basiclib.base.xui.widget.preview.KEY_PREVIEW_ITEM";
    public static final String KEY_DRAG = "com.lib.basiclib.base.xui.widget.preview.KEY_DRAG";
    public static final String KEY_SENSITIVITY = "com.lib.basiclib.base.xui.widget.preview.KEY_SENSITIVITY";
    public static final String KEY_PROGRESS_COLOR = "com.lib.basiclib.base.xui.widget.preview.KEY_PROGRESS_COLOR";
    ...
    private void initArgs() {
        ...
        if (bundle != null) {
           ...
           if (mRootView!=null)mRootView.setTag(mPreviewInfo.getUrl());
            //是否展示动画
        ...
        if (isSingleFling) {
            mImageView.setOnViewTapListener((view, x, y) -> {
        ...
        mImageView.setAlphaChangeListener(alpha -> {
            if (alpha == 255) {
                String video = mPreviewInfo.getVideoUrl();
                if (video != null && !video.isEmpty()) {
                    mBtnVideo.setVisibility(View.VISIBLE);
        ...
        mImageView.setTransformOutListener(() -> transformOut());
    }
