package com.lib.basiclib.base.delegate
...
import com.lib.basiclib.widget.dialog.MaterialConfirmDialog
import com.lib.basiclib.widget.dialog.MaterialLoadingDialog
import com.lib.basiclib.widget.dialog.MaterialTipsDialog
...
class PageViewDelegate(private val view: View?) {
    ...
    fun setPageTitle(toolbar: TextView?, title: String?) {
        if (mPageTitle != title) {
            mPageTitle = title
        }
        toolbar?.text = title
