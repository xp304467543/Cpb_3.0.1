...
package com.lib.basiclib.base.recycle;
...
public abstract class XRecyclerAdapter<T, V extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<V> {
     ...
     * @param data     列表项
     */
    protected abstract void bindData(@NonNull V holder, int position, T data);
    ...
    public V onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (mClickListener != null) {
            holder.itemView.setOnClickListener(v -> mClickListener.onItemClick(holder.itemView, getItem(holder.getLayoutPosition()), holder.getLayoutPosition()));
        }
