...
class LiveRoomChatAdapter(private val context: Context, private val fragmentManager:FragmentManager) :
    ...
    private fun initRed(
        ...
        when (data?.vip) {
            "1" -> holder.findViewById<ImageView>(R.id.imgVip).setBackgroundResource(R.mipmap.v1)
            "2" -> holder.findViewById<ImageView>(R.id.imgVip).setBackgroundResource(R.mipmap.v2)
            "3" -> holder.findViewById<ImageView>(R.id.imgVip).setBackgroundResource(R.mipmap.v3)
            "4" -> holder.findViewById<ImageView>(R.id.imgVip).setBackgroundResource(R.mipmap.v4)
            "5" -> holder.findViewById<ImageView>(R.id.imgVip).setBackgroundResource(R.mipmap.v5)
            "6" -> holder.findViewById<ImageView>(R.id.imgVip).setBackgroundResource(R.mipmap.v6)
            "7" -> holder.findViewById<ImageView>(R.id.imgVip).setBackgroundResource(R.mipmap.v7)
